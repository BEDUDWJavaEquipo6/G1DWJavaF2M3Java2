...
public class EmpleadoRepository {
    ...
    public Mono<Empleado> findEmpleadoData(String id){
    ...
    public Mono<Empleado>findAllEmpleadoById(String id){
        return Mono.just(empleadoData.get(id));
    }
    ...
    public Mono<Empleado> updateEmpleadoById(String id,Empleado empleado){
